...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@poreddypallavi" },
      { name: "twitter:title", content: "Poreddy Pallavi — Java Full Stack Developer" },
      { name: "twitter:description", content: "Portfolio of Poreddy Pallavi, an AIML graduate and aspiring Java Full Stack Developer." },
